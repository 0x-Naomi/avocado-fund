...
contract AVOTokenTest is Test {
    ...
    function test_MaxSupply() public view {
        assertEq(avo.MAX_SUPPLY(), 100_000_000e18);
    }
    ...
    function test_MinterIsZeroInitially() public view {
        assertEq(avo.minter(), address(0));
    }
    ...
    function test_SetMinter_EmitsEvent() public {
        ...
        emit AVOToken.MinterUpdated(address(0), minter);
        avo.setMinter(minter);
    }
    ...
    function test_Mint_ExactlyMaxSupply() public {
        ...
        vm.prank(minter);
        avo.mint(alice, 100_000_000e18);
        assertEq(avo.totalSupply(), 100_000_000e18);
