...
contract IntegrationTest is Test {
    ...
    function test_FullLifecycle() public {
        ...
        vm.prank(borrowerA);
        lending.borrow(120_000e6, BORROW_RATE);
        vm.prank(borrowerB);
        lending.borrow(60_000e6, BORROW_RATE);
        ...
        vm.prank(owner); vault.collectFees();
    ...
    function test_LateDepositor_FairShareAllocation() public {
        ...
        vm.prank(borrowerA);
        lending.borrow(90_000e6, BORROW_RATE);
    ...
    function test_PartialRepayment_PrincipalReduces() public {
        ...
        vm.prank(borrowerA);
        uint256 loanId = lending.borrow(100_000e6, BORROW_RATE);
    ...
    function test_BorrowerDefault_VaultAbsorbsLoss() public {
        ...
        vm.prank(borrowerA);
        lending.borrow(100_000e6, BORROW_RATE);
