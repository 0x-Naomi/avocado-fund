...
contract AvocadoLendingTest is Test {
    ...
    function test_RevokedBorrowerCannotBorrow() public {
        ...
        vm.prank(borrower);
        vm.expectRevert();
        lending.borrow(1_000e6, BORROW_RATE);
    }
    ...
    function test_Borrow_Basic() public {
        ...
        vm.prank(borrower);
        uint256 loanId = lending.borrow(amount, BORROW_RATE);
    ...
    function test_Borrow_ZeroAmountReverts() public {
        vm.prank(borrower);
        vm.expectRevert();
        lending.borrow(0, BORROW_RATE);
    }

    function test_Borrow_ExceedsCreditLimitReverts() public {
        vm.prank(borrower);
        vm.expectRevert();
        lending.borrow(CREDIT_LIMIT + 1, BORROW_RATE);
    }

    function test_Borrow_UpToLimitThenReverts() public {
        vm.prank(borrower);
        lending.borrow(CREDIT_LIMIT, BORROW_RATE);

        vm.prank(borrower);
        vm.expectRevert();
        lending.borrow(1e6, BORROW_RATE);
    }
    ...
    function test_Borrow_DefaultedBorrowerReverts() public {
        vm.prank(borrower);
        lending.borrow(10_000e6, BORROW_RATE);
    ...
    function test_Borrow_MultipleLoanIds() public {
        ...
        uint256 id0 = lending.borrow(10_000e6, BORROW_RATE);
        uint256 id1 = lending.borrow(5_000e6, BORROW_RATE);
        vm.stopPrank();
    ...
    function test_Repay_Basic() public {
        ...
        vm.prank(borrower);
        uint256 loanId = lending.borrow(borrowAmt, BORROW_RATE);
    ...
    function test_Repay_AlreadyRepaidReverts() public {
        vm.prank(borrower);
        uint256 loanId = lending.borrow(10_000e6, BORROW_RATE);
    ...
    function test_RepayAll() public {
        vm.startPrank(borrower);
        lending.borrow(20_000e6, BORROW_RATE);
        lending.borrow(10_000e6, BORROW_RATE);
        vm.stopPrank();
    ...
    function test_InterestAccrual_1Year_12pct() public {
        ...
        vm.prank(borrower);
        lending.borrow(principal, BORROW_RATE);
    ...
    function test_AccrueAllInterest_MultipleBorrowers() public {
        ...
        vm.prank(borrower);
        lending.borrow(50_000e6, BORROW_RATE);

        vm.prank(borrower2);
        lending.borrow(30_000e6, BORROW_RATE);

        vm.warp(block.timestamp + 90 days);

        uint256 totalInterest = lending.accrueAllInterest(lending.getBorrowerList());
    ...
    function test_TotalOutstandingDebt_IncludesInterest() public {
        ...
        vm.prank(borrower);
        lending.borrow(amount, BORROW_RATE);
    ...
    function test_Unpause_RestoresBorrowing() public {
        ...
        vm.prank(borrower);
        lending.borrow(1_000e6, BORROW_RATE); // succeeds
    }
    ...
    function test_GetLoan() public {
        vm.prank(borrower);
        lending.borrow(15_000e6, BORROW_RATE);
